                            ...
                            <table class="table table-striped table-bordered table-hover">
                                {if isset($rows_bill)}
                                    {foreach from=$rows_bill key=key item=link}
                                        ...
                                        <tr>
                                            <th>مبلغ قبض</th>
                                            <td>{$link.amount|number_format} تومان</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th>نتیجه</th>
                                            <td>{if $link.status eq 'paid'}
                                                    <span class="btn-success btn-xs">پرداخت شده</span>
                                                {elseif $link.status eq 'unpaid'}
                                                    <span class="btn-danger btn-xs">پرداخت نشده</span>
                                                {/if}</td>
                                        </tr>
                                        <tr>
                                            <th>تاریخ ایجاد</th>
                                            <td>{$link.date|jdate_format}</td>
                                        </tr>
                                        {if $link.status eq 'paid'}
                                            <tr>
                                            <th>تاریخ پرداخت</th>
                                            <td>{$link.pay_date|jdate_format}</td></tr>{/if}
                                        {if $link.status eq 'paid'}
                                            <tr>
                                            <th>شماره پیگیری</th>
                                            <td>{$link.refcode}</td></tr>{/if}
                                    {/foreach}
                                {/if}
                            </table>
                        </div>
